...
const NavbarMobile = () => {
	...
	const circlePosition = Math.round(window.innerWidth / 50 / 10) * 8.5;
	...
	return (
		<div className='fixed bg-white bottom-0 left-0 right-0 shadow-[0_-2px_5px_rgba(0,0,0,0.25)] py-2 z-50'>
			<div
				...
				style={{
					left: `${circlePosition + selected.index * 33.33}%`,
...
const navItems = [
...

	{
		name: 'Promoters',
		link: '/promoters',
		outlineIcon: 'https://img.icons8.com/ios/50/9e9e9e/talk-male.png',
		fillIcon: 'https://img.icons8.com/ios-filled/50/ffffff/talk-male.png'
	}
];
